...
#define EL_CTRL_ONE_KEY_RECORDING			0x1 //一键录音录像
#define EL_CTRL_SCAN						0x2 //拍照
#define EL_CTRL_AF_FOCUS					0x3 //AF自动对焦
#define EL_CTRL_RESOLUTION_SWITCHING		0x4 //分辨率切换
#define EL_CTRL_TEXT_OR_IMAGE				0x5 //文本、图像循环切换
#define EL_CTRL_LEFT						0x6 //向左/镜头焦距向近微调
#define EL_CTRL_RIGHT						0x7 //向右/镜头焦距向远微调
#define EL_CTRL_UP 							0x8 //向上/图像放大
#define EL_CTRL_DOWN						0x9 //向下/图像放小
#define EL_CTRL_OK		 					0x10 //OK/确认
#define EL_CTRL_DELETE		 				0x11 //删除
#define EL_CTRL_FILE_PREVIEW		 		0x12 //文件预览
#define EL_CTRL_SCREEN_ROTATE		 		0x13 //画面旋转
#define EL_CTRL_SCREEN_FREEZES		 		0x14 //标题冻结、全屏冻结、解除循环切换
#define EL_CTRL_SCREEN_NORMAL		 		0x15 //镜像、黑白、正负片、正常循环切换
#define EL_CTRL_SCREEN_COMPARE		 		0x16 //同屏对比
#define EL_CTRL_VHU_SWITCHING		 		0x17 //VGA、HDMI/USB循环切换
#define EL_CTRL_LANGUAGE_SWITCHING			0x18 //语言切换
#define EL_CTRL_BRIGHTNESS_SUB				0x19 //亮度-
#define EL_CTRL_BRIGHTNESS_ADD				0x20 //亮度+
#define EL_CTRL_EXIT						0x21 //返回、退出
#define EL_CTRL_MENU						0x22 //菜单、设置选项
#define EL_CTRL_MICROPHONE_OPEN_CLOSE		0x23 //麦克风开关
#define EL_CTRL_COLOR_BLACK_SWITCHING		0x24 //彩色、黑白循环切换
#define EL_CTRL_FILL_LIGHT_SWITCHING		0x25 //补光灯开关（0-1档）
#define EL_CTRL_FILL_AND_LIGHT_SWITCHING	0x26 //补光灯开关与亮度调节（0-3档）
#define EL_CTRL_COLOR_LIGHT_SWITCHING_FOUR	0x27 //1白光、2红色、3绿色和4蓝色，（四档）循环切换
#define EL_CTRL_COLOR_LIGHT_SWITCHING_THREE	0x28 //1红色、2绿色和3蓝色，      （三档）循环切换

/*Remote control upload define*/
#define EL_CTRL_ZHANGTAILIANJIE				0x29 //展台联机
#define EL_CTRL_WENBENTUXIANG				0x30 //文本/图像
#define EL_CTRL_BUGUANGDENG					0x31 //补光灯
#define EL_CTRL_DONGJIE						0x32 //冻结
#define EL_CTRL_TUPIANLIULAN				0x33 //图片浏览
#define EL_CTRL_TUXIANGXIAOGUO				0x34 //图像效果
#define EL_CTRL_FANGDA						0x35 //放大
#define EL_CTRL_PAIZHAO						0x36 //拍照
#define EL_CTRL_SUOXIAO						0x37 //缩小
#define EL_CTRL_XIANGZUO					0x38 //向左
#define EL_CTRL_SHANCHU						0x39 //删除
#define EL_CTRL_XIANGYOU					0x40 //向右
#define EL_CTRL_JUJING						0x41 //聚近
#define EL_CTRL_JUJIAO						0x42 //聚焦
#define EL_CTRL_JUYUAN						0x43 //聚远
#define EL_CTRL_FENGBIANLV					0x44 //分辨率
#define EL_CTRL_XUANZHUAN					0x45 //旋转
#define EL_CTRL_ERFENGPINGXIAN				0x46 //二分屏显
...
/*Xu Tool*/
#define EL_XUTOOL_NORMAL                    0X0//未按键
#define EL_XUTOOL_PRESS                     0X1//按下按键
...
/*****************************说明************************************
增加了设置stillcapture 获取图像的设置功能
stillImageFun： 设置回调返回still 图像数据
stillImageParam： 设置对象
resolutionForStill： still capture通道的分辨率
subtypeForStill： still capture 通道的出图格式
**********************************************************************/
ELAPI(int)
elStartPreview(
	ELdevice dev,
...
用来判断是否是活体
返回值 1活体 0 照片 -1失败
参数 color_image 正常彩色图片
	black_image  红外黑白图片
	nThreshold   判别门限值  推荐30
	dwReserved  保留
******/
ELAPI(int)
	DetectFaceLive(
...
/*
* 图像自动白底，要求拍摄背景为白色，被拍摄对象着深色衣物
* flag 保留
* threshold 非白点的判定阈值，小于此值判定为非白点，有效值取值范围为0~255。传-1则算法自动计算，建议值-1
* autoThresholdRatio threshold为-1时，此参数有效，为自动计算出的阈值的下调参数，取值范围为0~1，建议值0.85
* aroundNum 非白点判定时的邻域大小参数，取值范围2~8，建议值5
* lowestBrightness 图像容许的最低亮度值，若低于此值，算法将自动调整至此值，取值范围0~255，建议值180
*/
ELAPI(int)
	elWhitenImage(
	ELimage image,
